  ...
  return (
    <div className="min-h-screen flex flex-col items-center pt-12 pb-12 px-4 transition-colors duration-500 dark:bg-morandi-darkBase">
      ...
      <div className="flex items-center justify-center gap-8 mb-10">
          ...
          <button onClick={toggleTimer} className={`h-20 w-20 rounded-full bg-white dark:bg-gray-800 shadow-ios-float border border-gray-100 dark:border-gray-700 transition-all flex items-center justify-center ${isActive ? 'text-morandi-text-primary dark:text-white' : 'text-morandi-work'}`}>
